      ...
      <div class="section">
        ...
        <table class="table">
      	...
      	String pass = pageContext.getServletContext().getInitParameter("password");
			...
			PreparedStatement pst = con.prepareStatement("select * from contenstant left join party on contenstant.party_id = party.party_id left join booth on contenstant.booth_id = booth.booth_id where booth.booth_name = ?");
		...
		%>
          <tr>
            ...
            <td><a href="party.jsp?party_name=<%= rs.getString("party_name") %>"><%= rs.getString("party_name") %></a></td>
