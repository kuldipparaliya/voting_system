...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/total_vote.css" />
    <link
    ...
    <section>
      <div class="section">
        <div class="container-header">
          <h1 class="head">Booth :<%= booth_name %></h1>
        </div>
        ...
        <table class="table">
      	...
      	String pass = pageContext.getServletContext().getInitParameter("password");
			...
			PreparedStatement pst = con.prepareStatement("select * from contenstant left join booth on contenstant.booth_id = booth.booth_id left join party on contenstant.party_id = party.party_id where booth_name = ?");
          ...
          <tr>
            ...
            <td><a href = "vote_party.jsp?party_name=<%= rs.getString("party_name") %>"><%= rs.getString("party_name") %></a></td>
